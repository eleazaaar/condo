                                                        ...
                                                        <tr>
                                                            <td class="mcnTextContent" valign="top" style="padding:0 9px 0 9px;" width="564">
                                                                <div style="text-align: center;"><br>
                                                                    <font face="arial, helvetica neue, helvetica, sans-serif"><span style="font-size:24px"><strong>Account Activation</strong></span></font>
                                                                </div>
                                                            </td>
                                                        </tr>
                                                    </tbody>
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td valign="top" class="mcnTextContent" style="padding: 0px 18px 9px; font-family: Roboto, &quot;Helvetica Neue&quot;, Helvetica, Arial, sans-serif; font-size: 18px; font-style: normal; font-weight: bold;">
                                                            <h1 style="text-align: center;"><strong><span style="font-size:12px">Your account need to be activated.</span></strong></h1>
                                                        </td>
                                                    </tr>
                                                </tbody>
                                            </table>
                                        ...
                                        <td valign="top" class="mcnTextBlockInner" style="padding-top:9px;">
                                            <table align="left" border="0" cellpadding="0" cellspacing="0" style="max-width:100%; min-width:100%;" width="100%" class="mcnTextContentContainer">
                                                <tbody>
                                                    <tr>
                                                        <td valign="top" class="mcnTextContent" style="padding: 0px 18px 9px; font-family: Roboto, &quot;Helvetica Neue&quot;, Helvetica, Arial, sans-serif; font-size: 18px; font-style: normal; font-weight: bold;">
                                                            <h1 style="text-align: center;"><span style="font-size:12px"><strong>Please enter the activation code to unlock your account</strong></span></h1>
                                                        </td>
                                                    </tr>
                                                </tbody>
                                            </table>
                                ...
                                <tbody class="mcnButtonBlockOuter">
                                    <tr>
                                        <td style="padding-top:0; padding-right:18px; padding-bottom:18px; padding-left:18px;" valign="top" align="center" class="mcnButtonBlockInner">
                                            <table border="0" cellpadding="0" cellspacing="0" class="mcnButtonContentContainer" style="border-collapse: separate !important;border-radius: 8px;background-color: #EEE;">
                                                <tbody>
                                                    <tr>
